...
* If the file is present in the @dropsync@ folder (e.g. @dropsync/.bashrc@) and a file exists in the original location (e.g. @/home/<username>/.bashrc@), the original file will be moved for backup (e.g. @/home/<username>/.bashrc.ds_<timestamp>@) and a new symbolic link will be created (e.g. @/home/<username>/.bashrc -> dropbox/.bashrc@).
